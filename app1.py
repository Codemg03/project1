...
# =========================
# SAFE MODEL LOADING (LAZY + ERROR HANDLING)
# =========================
@st.cache_resource
def load_models():
    try:
...
# =========================
# RECURSIVE FORECAST (OPTIMIZED, SAFE)
# =========================
...
# =========================
# FORECAST LOGIC (SAFE + LAZY MODELS)
# =========================
...
if model_choice == "Naïve Persistence":
    ...
    sarima = models.get("sarima_model")
    forecast = sarima.forecast(steps=forecast_horizon) if sarima else np.repeat(last_value, forecast_horizon)

elif model_choice == "ETS":
    ets = models.get("ets_model")
    forecast = ets.forecast(forecast_horizon) if ets else np.repeat(last_value, forecast_horizon)
